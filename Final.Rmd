...
PCT_LACCESS_POP15+PCT_LACCESS_HHNV15+PCT_LACCESS_SNAP15+PCT_LACCESS_CHILD15+PCT_NHWHITE10+ PCT_NHASIAN10+PCT_NHNA10+PCT_NHPI10+FSRPTH16+PCT_SNAP17+ PCT_OBESE_ADULTS17+PCT_NHBLACK10+PCT_HISP10+GROCPTH16
...
while (s <= S) {
  try({
    ...
    res_partial_model <- lm(cbind(FOODINSEC_15_17, CH_FOODINSEC_14_17, VLFOODSEC_15_17) ~ PCT_NHBLACK10+ PCT_HISP10+GROCPTH16 + SUPERCPTH16 + WICSPTH16 + FFRPTH16 + PCT_REDUCED_LUNCH15+RECFACPTH16,data = bstp_df)
