...
Now that we ran our multivariate linear model with all of our predictor variables, we also ran a restricted model including all of the variables that were signicant in our previous model
...
```{r}
variables_to_test <-  c("PCT_LACCESS_POP15", "PCT_LACCESS_HHNV15", "PCT_LACCESS_SNAP15", "LACCESS_CHILD15", "PCT_NHWHITE10", "PCT_NHBLACK10", "PCT_HISP10", "PCT_NHASIAN10", "PCT_NHNA10", "PCT_NHPI10", "GROCPTH16", "SUPERCPTH16", "WICSPTH16", "FFRPTH16", "FSRPTH16", "PCT_SNAP17", "PCT_REDUCED_LUNCH15", "PCT_OBESE_ADULTS17", "RECFACPTH16")
...
while (s <= S) {
  try({
    ...
    res_partial_model <- lm(cbind(FOODINSEC_15_17, CH_FOODINSEC_14_17, VLFOODSEC_15_17) ~ PCT_LACCESS_POP15+PCT_LACCESS_HHNV15+PCT_LACCESS_SNAP15+PCT_LACCESS_CHILD15+PCT_NHWHITE10+ PCT_NHASIAN10+PCT_NHNA10+PCT_NHPI10+FSRPTH16+PCT_SNAP17+ PCT_OBESE_ADULTS17,data = bstp_df)
