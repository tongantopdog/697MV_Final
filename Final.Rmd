...
Using the data from the data from the FDA, we are interested in measuring the possible impact the environmental predictor variables described above with household 
